...
alphaspec prompts are installed as Windsurf workflows in `.windsurf/workflows/`. Invoke them in Cascade by typing `/create-story`, `/complete-story`, `/implement-story`, `/define-principles`, or `/bootstrap-from-research`.
