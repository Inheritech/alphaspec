...
alphaspec prompts are installed as Windsurf workflows in `.windsurf/workflows/`. Invoke them in Cascade by typing `/alphaspec.create-stories`, `/alphaspec.complete-story`, `/alphaspec.implement-story`, `/alphaspec.verify-story`, `/alphaspec.define-principles`, or `/alphaspec.bootstrap-from-research`.
